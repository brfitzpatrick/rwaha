...
These summary statistics were calculated by Andri for the values of the pixels of these DEM products that intersected a 12.5m radius disk buffer centered on the coordinates of the centroid of each of the NFI Plots.
...
When he provided these data, Andri also alerted me to the fact that some CLNR have missing values for some of the Moran's I statistics.
