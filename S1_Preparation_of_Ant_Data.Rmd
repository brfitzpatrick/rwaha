...
| UMFANG               | Size of tree from which Ants were collected???               | Coauthor's best guess                           |
...
#### checking my filtering against *Coauthor's name obfuscated*'s filtering:

*Coauthor's name obfuscated* reported 203 NFI plots with Red Wood Ant mounds from 2009-2014
...
*Coauthor's name obfuscated* choose to restrict his analysis to the `Wald` plots writing: 
