...
| UMFANG               | Size of tree from which Ants were collected???               | MLV's best guess                           |
...
#### checking my filtering against MLV's filtering:

MLV reported 203 NFI plots with Red Wood Ant mounds from 2009-2014
...
MLV choose to restrict his analysis to the `Wald` plots writing: 
