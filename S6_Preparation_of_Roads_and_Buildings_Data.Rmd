...
In this file I prepare the data Marielle calculated with ArcMap that quantify for each plot the distance from the plot centre to each of the nearest small road, big road and building.
