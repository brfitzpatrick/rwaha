...
Anita and I read through the NFI Field Manual and selected a set of variables from the NFI Interviews Data that we think have the potential to be relevant to the distributions of ant mounds.
...
| Excel Sheet Column Name  | NAFIDAS Entry                                    | DeepL Translation of NAFIDAS Entry                             | MID 329 Description (Christoph has Checked)                                                | MID 329 Code (Christoph has Checked) |
|--------------|--------------------------------------------------|----------------------------------------------------------------|-----------------------------------------------------------------------------|----------------------|
...
I have discussed this with Anita and we have decided to combine the 26 plots with `Unknown` forest origin with the 5502 plots with the `Always forest` forest origin.
...
I asked Christoph how we could combine some of these harvesting methods into new categories based on similar levels of habitat disturbance associated with each of these harvesting methods and he suggested the the following four groups of categories.
...
Christoph recommends that I only use FLSCHUMF1 where there is a corresponding FLSCHJAHR1 value and that I recode the remainder as `no damage` (code 15).
...
I have discussed aggregations of these categories with Anita and Christoph and we have agreed on the following aggregations.
...
At Christoph's suggestion, below I compare LETZTENU to my attempt to calculate an equivalent from WABAEJAHR and DATUMF.
...
Christoph and I discussed this discrepancy and Christoph has recommended the following approach to calculating the years since the most recent silvicultural treatment (intervention).
...
Christoph writes that: 'when it concerns to the years of the LFI4 (2009-2017), the silvicultural intervention in the corresponding year always took place before the field was surveyed. If you are also interested in the interventions before 2009, I would have to think about how it could be derived.'
